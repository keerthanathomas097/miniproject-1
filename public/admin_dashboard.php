...
$query = "SELECT o.outfit_id, u.name, u.email, u.phone, o.category, o.size, o.brand, 
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav>
            ...
            <a href="outfit_mangement.php" class="sidebar-link"><i class="fas fa-tshirt me-2"></i> Outfit Management</a>
