    ...
    <div class="main-content">
        ...
        <div class="profile-header">
            <div class="profile-title">
                <h1>My Profile</h1>
                <p>Welcome, <?php echo htmlspecialchars($lender['name']); ?></p>
            </div>
        ...
        <div class="profile-section">
            ...
            <div class="profile-info">
                <div class="info-item">
                    <label>Name</label>
                    <span><?php echo htmlspecialchars($lender['name']); ?></span>
                </div>
                <div class="info-item">
                    <label>Email</label>
                    <span><?php echo htmlspecialchars($lender['email']); ?></span>
                </div>
                <div class="info-item">
                    <label>Phone</label>
                ...
                <div class="info-item">
                    ...
                    <span class="status-badge <?php echo $lender['is_verified'] ? 'verified' : 'pending'; ?>">
                        <?php echo $lender['is_verified'] ? 'Verified' : 'Pending Verification'; ?>
                    </span>
                </div>
            </div>
        </div>
